...
module Neuron =
    ...
    let compute (neuron : Neuron) (input : float[]) =
        // function that return an array of float
...
module Layer =
    ...
    // function to create a Layer type
    ...
    let create (neuronsCount:int) (ctorFunc:int -> Neuron) =
        {
...
// Single hidden layer called Network, which is just an alias for the Layer :)
